---
source_file: "custom_ws/src/mycobot_hw_interface/mycobot_hw_interface/simple_master_bridge.py"
type: "code"
...
# SimpleMasterBridge ROS2 Node

## Connections
- [[JointStateRelay ROS2 Node]] - `shares_data_with` [INFERRED]
- [[MyCobotBridge ROS2 Node]] - `conceptually_related_to` [INFERRED]
